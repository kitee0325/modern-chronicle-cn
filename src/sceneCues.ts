...
export const sceneCueManifests: readonly SceneCueManifest[] = [
  ...
  },
  {
    ...
    cues: [
      ...
      textCue('s10-chart-caption', '444:7', 'copy', 1151, 117, 343, 22, [
        textBlock(
          '444:7',
          '1948-1966年中国择偶标准情况',
          0,
          ...
          259,
          22,
          { fontSize: 16, lineHeight: 24, align: 'left' },
        ),
      ]),
      textCue('s10-source', '76:11717', 'source', 1146, 727, 1485, 60, [
        textBlock(
          '444:11',
          ...
          1485,
          20,
          { fontSize: 10, lineHeight: 20, color: WHITE, align: 'left' },
        ),
        textBlock(
          '76:11719',
          ...
          1485,
          24,
          { fontSize: 10, lineHeight: 20, color: WHITE, align: 'left', role: 'source' },
        ),
      ]),
    ],
  },
  ...
  },
  {
    ...
    cues: [
      ...
      textCue('s17-source-copy', '76:20779', 'copy', 0, 558, 1922, 160, [
        textBlock(
          '76:16658',
          ...
          690,
          160,
          { fontSize: 10, lineHeight: 20, align: 'left' },
        ),
      ]),
      textCue('s17-source', '76:20779', 'source', 0, 730, 1922, 80, [
        textBlock(
          '76:16650',
          '数据来源：[1]《中国乡镇企业年鉴（1997）》；[2]国家统计局《之六：乡镇企业异军突起》',
          878,
          33,
          1036,
          24,
          { fontSize: 10, lineHeight: 20, role: 'source' },
        ),
      ]),
    ],
  },
